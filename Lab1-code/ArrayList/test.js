...
describe("ArrayList", function () {
    ...
    describe("contain() method", function () {
        ...
        it(" check if the list contains the element ", function () {

            let mylist = ["big", "small", "tall", "short", "round", "square", "enormous", "tiny", "gargantuan", "lilliputian", "numberless", "none", "vast", "miniscule"];
           ...
           assert.equal(arrayList.contains("tiny"),12);
